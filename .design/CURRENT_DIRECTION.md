...
5. **Scene 05: Engineering Undergraduate Thesis / Synthesis**
   - Status: **Scene 05.1A, 05.1B-1, 05.1B-2A & 05.1B-2B Owner-approved baseline (frozen)**; 05.1B-3 (overhead vapor line, condensation, extraction pump & distillate collection) planned.
   - Authority Brief: `.design/CHAPTER_02_SCENE_05_BRIEF.md`.
   - Approved Exploratory Workspace: `prototypes/scene-05-apparatus-explorations/index.html` (Study C: 2D orthographic editorial representation of Universitas Indonesia test rig with approved 05.1B-1 feed/heating/throttling approach, 05.1B-2A isenthalpic throttling restriction crossing/flash onset, and 05.1B-2B flash vessel phase separation [vapor rise, liquid settling, and brine basin drainage]).
   - Scope Rule: All major equipment positions, piping topology, supports, and causal motion up to the separated readiness hold ($t = 36.0\,\text{s}$) are frozen baseline. Section 05.1B-3 (vapor transfer through overhead condenser line, condenser cooling, distillate extraction pump, and aquadest collection) has not started.
...
- Scene 05.1A / 05.1B-1 / 05.1B-2A / 05.1B-2B: Owner approved baseline (frozen; physical apparatus composition, feed/heating/throttling, throttling crossing / flash onset, and flash vessel phase separation in `prototypes/scene-05-apparatus-explorations/`).
