...
## Desired Visitor Discovery

Visitors should naturally discover that Fauzan:

- starts from business problems,
- understands process and operational logic,
- uses technology to make systems visible,
- keeps learning across domains,
- uses AI as an execution accelerator,
- applies human judgment to validate the result.
...
Interactions should clarify relationships, not decorate the page.

Use motion and reveal behavior only when they help visitors understand:

- how capabilities connect,
- how a question becomes a system,
- why a case study proves business understanding,
- what evidence supports the claim.

Avoid noisy interactions, excessive animation, project-card clutter, and resume-like chronology.
