...
- `../prototypes/new-portfolio-animation-first/index.html` is the active Chapter 02 prototype workspace:
  ...
  - **Scene 05**: Undergraduate Thesis / Synthesis (Scene 05.1A physical apparatus composition, 05.1B-1 feed/heating/throttling motion, 05.1B-2A isenthalpic throttling crossing / flash onset, 05.1B-2B flash vessel phase separation, 05.1B-3A vapor transport to condenser inlet, and 05.1B-3B condensation across illustrative cooling path owner-approved and frozen in isolated workspace `../prototypes/scene-05-apparatus-explorations/index.html`; governance authority in `../.design/CHAPTER_02_SCENE_05_BRIEF.md`; 05.1B-3C planned).
