...
- `../prototypes/new-portfolio-animation-first/index.html` is the active Chapter 02 prototype workspace:
  ...
  - **Scene 05**: Undergraduate Thesis / Synthesis (Scene 05.1A physical apparatus composition owner-approved and frozen in isolated workspace `../prototypes/scene-05-apparatus-explorations/index.html`; governance authority in `../.design/CHAPTER_02_SCENE_05_BRIEF.md`; 05.1B+ planned).
